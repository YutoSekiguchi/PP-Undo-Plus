...
export default function NowAvgPressureGauge(props: Props) {
  ...
  return (
    <div className="moveNowBorderLinearProgress" style={{ 
      left: (pointerPosition.x + editorUtils.getCameraData().x)*editorUtils.getCameraData().z, 
      top: (pointerPosition.y + editorUtils.getCameraData().y)*editorUtils.getCameraData().z - 40,
    }}>
